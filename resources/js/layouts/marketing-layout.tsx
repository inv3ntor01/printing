                ...
                <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4">
                    ...
                    {auth.user ? (
                        <div className="relative">
                            <button
                                onClick={() => setMenuOpen(!menuOpen)}
                                className="big-primary flex items-center gap-1 rounded px-4 py-2 text-sm font-semibold text-white hover:bg-[#0891b2]"
                            >
                                {auth.user.name}
                        ...
                        <Link
                            href={login().url}
                            className="big-primary rounded px-4 py-2 text-sm font-semibold text-white hover:bg-[#0891b2]"
                        >
                            Login
                        </Link>
                    )}
                    ...
                    <div className="grid gap-8 md:grid-cols-5">
                        ...
                        <div>
                            ...
                            <ul className="space-y-2 text-sm">
                                ...
                                <li>
                                    <Link href={servicesRoute().url}>
                                        Our Services
                                    </Link>
                                </li>
                                <li>
                                    <Link href={contactUs().url}>
                                        Contact Us
                                    </Link>
                                </li>
                            </ul>
                        ...
                        <div>
                            ...
                            <ul className="space-y-2 text-sm">
                                ...
                                <li>
                                    <Link href={compliance().url}>
                                        Data & Compliance (CCPA/GDPR)
                                    </Link>
                                </li>
                                <li>
                                    <Link href={ip().url}>IP Infringement</Link>
                                </li>
                            </ul>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <p className="text-sm">
                                Precision engineering solutions for the modern
                                print landscape. Reliability at scale.
                            </p>
                        </div>
                    </div>
                    <div className="mt-8 border-t border-border pt-8 text-center text-xs">
                        © {new Date().getFullYear()} VBTecH Solutions. Precision
