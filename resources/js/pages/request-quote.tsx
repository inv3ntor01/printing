                ...
                <section className="bg-white py-24">
                    <div className="mx-auto max-w-lg px-4 text-center">
                        ...
                        <p className="mt-3 text-black">
                            We've received your technical specifications and
                            will get back to you within 24 hours with a precise
                ...
                <div className="mx-auto max-w-7xl px-4">
                    <div className="grid gap-12 lg:grid-cols-12">
                            ...
                            >
                                ...
                                <div>
                                    <label className="mb-1 block text-sm font-medium text-black">
                                        Specification File / Artwork (Max 50MB)
                                    </label>
                                    <div
                                ...
                                <div>
                                    <label
                                        ...
                                        className="mb-1 block text-sm font-medium text-black"
                                    >
                                        Project Requirements & Finishing
                                    </label>
                                    <textarea
                        ...
                        <aside className="space-y-8 lg:col-span-5">
                                ...
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="mt-1 text-sm text-black">
                                            Industrial Sector 7, Tech Park East
                                            <br />
                            ...
                            <div className="rounded-lg border border-slate-200 p-6">
                                <h3 className="mb-4 text-sm font-semibold tracking-wider text-black uppercase">
                                    Turnaround & Logistics
                                </h3>
                                <div className="space-y-5 text-sm">
                                    <div>
                                        <div className="font-medium text-black">
                                            Standard Technical Production
                                        </div>
                                        <p className="mt-0.5 text-black">
                                            3 - 5 business days after artwork
                                            approval. This applies to most litho
                                            and digital runs.
                                        </p>
                                    </div>
                                    <div>
                                        <div className="font-medium text-black">
                                            Precision Finishing & Die-Cutting
                                        </div>
                                        <p className="mt-0.5 text-black">
                                            5 - 8 business days. Complex jobs
                                            involving foil, spot UV, or custom
                                            dies require extended curing and
                                            set-up times.
                                        </p>
                                    </div>
                                    <div>
                                        ...
                                        <p className="mt-0.5 text-black">
                                            ...
                                            for specific digital and wide-format
                                            requirements. Surcharges apply.
                                        </p>
                                    </div>
                                </div>
                            </div>
