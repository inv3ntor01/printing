                    ...
                    <div className="grid gap-12 lg:grid-cols-3">
                        ...
                        >
                            ...
                            <div>
                                ...
                                <label
                                    htmlFor="contact-file"
                                    className="flex cursor-pointer items-center gap-2 rounded border border-dashed border-slate-300 px-4 py-3 text-sm text-slate-500 hover:border-[#06b6d4]"
                                >
                                ...
                                <div className="space-y-4 text-sm">
                                    <div className="flex items-start gap-3">
                                        ...
                                        <span className="text-slate-600">
                                            HQ Engineering Hub, Silicon Valley
                                        </span>
                                    </div>
                                    <div className="flex items-start gap-3">
                            ...
                            <div className="rounded-lg border border-slate-200 p-6">
                                ...
                                <div className="space-y-4 text-sm">
                                    ...
                                    <div>
                                        ...
                                        <div className="mt-0.5 text-slate-500">
                                            Quoted individually based on volume
                                        </div>
                                    </div>
                                </div>
                            </div>
