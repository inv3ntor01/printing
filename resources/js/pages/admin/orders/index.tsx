...
export default function Index({ orders: { data, current_page, last_page } }: { orders: PaginatedData }) {
    return (
        <>
            <Head title="Orders" />
            ...
            <div className="space-y-6">
                            ...
                            <tbody>
                                {data.map((order) => (
                                    <tr key={order.id} className="border-b last:border-0">
                                        ...
                                        <td className="px-4 py-3 text-muted-foreground">{order.job_type}</td>
                ...
                {last_page > 1 && (
                    <div className="flex items-center justify-center gap-2">
                        {current_page > 1 && (
                            <Link href={`/admin/orders?page=${current_page - 1}`}>
