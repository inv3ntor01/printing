                    ...
                    {({ processing, errors }) => (
                        <>
                            <div className="grid gap-2">
                                ...
                                <Input id="name" name="name" required placeholder="e.g. Premium Business Cards" />
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div className="grid gap-2">
                                    ...
                                    <Input id="delivery_time" name="delivery_time" placeholder="e.g. 3-5 business days" />
                            ...
                            <div className="flex items-center gap-4">
                                <Button disabled={processing}>Create Service</Button>
                            </div>
                        </>
                    )}
                </Form>
