...
const services = [
    {
        ...
        description:
            'Chronological, functional, and hybrid resumes tailored to your industry. Our writers align your narrative with recruiter expectations and ATS algorithms.',
        stats: '92%',
    ...
    },
    {
        ...
        description:
            'Advanced parsing analysis ensures your resume passes Applicant Tracking Systems. We reverse-engineer job descriptions to match the exact keywords and phrases.',
        stats: '98%',
    ...
    },
    {
        ...
        description:
            'Coordinated personal branding across your cover letter and LinkedIn profile. Consistent narrative, keyword alignment, and professional tone.',
        stats: '3x',
...
const process = [
    {
        ...
        description:
            'We review your career history, target roles, and industry trends. A deep dive into your professional journey to identify your unique value proposition.',
        step: '01',
    },
    {
        ...
        title: 'Draft & Design',
        description:
            'Our writers craft a tailored resume with modern formatting, ATS-compatible structure, and compelling achievement-driven bullet points.',
        step: '02',
    },
    {
        ...
        description:
            'You review the draft, request revisions, and approve the final version. Delivered in multiple formats: PDF, DOCX, and plain text.',
        step: '03',
    },
];
...
const features = [
    {
        ...
        description:
            'Specialized writers for tech, finance, healthcare, creative, and executive roles.',
    },
    {
        icon: <CheckCircle className="size-6" />,
        title: 'Unlimited Revisions',
        description:
            'Your satisfaction is guaranteed. Request as many revisions as you need within 30 days.',
    },
    {
        icon: <Shield className="size-6" />,
        title: 'Confidential & Secure',
        description:
            'Your documents are encrypted and never shared. Full confidentiality throughout the process.',
    },
];
                ...
                <div className="mx-auto max-w-7xl px-4">
                    ...
                    <div className="grid gap-8 md:grid-cols-3">
                        {services.map((service) => (
                            <div
                                key={service.title}
                                className="group rounded-lg border border-slate-200 p-8 transition hover:border-[#06b6d4]/30 hover:shadow-lg"
                            >
                ...
                <div className="mx-auto max-w-7xl px-4">
                    <div className="mb-12 text-center">
                        ...
                        <p className="mt-2 text-lg text-slate-500">
                            A streamlined three-step process from consultation
                            to final delivery.
                        </p>
                    </div>
                    <div className="grid gap-8 md:grid-cols-3">
            ...
            <section className="bg-white py-20">
                <div className="mx-auto max-w-7xl px-4">
                    <div className="mb-12 text-center">
                        ...
                        <p className="mt-2 text-lg text-slate-500">
                            We combine writing expertise with technical
                            precision to deliver results.
                        </p>
                    </div>
                    <div className="grid gap-8 md:grid-cols-3">
                        {features.map((feature) => (
                            <div
                                key={feature.title}
                                className="rounded-lg border border-slate-200 p-8 text-center"
                            >
            ...
            <section className="bg-[#0f172a] py-20">
                <div className="mx-auto max-w-3xl px-4 text-center">
                    ...
                    <p className="mt-3 text-lg text-slate-400">
                        Get a free consultation and quote. Our team will analyze
                        your current resume and provide personalized
                        recommendations.
                    </p>
                    <Link
